    ...
    <div class="navbar">
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="mdShow=true" v-show="!nickName">Login</a>
      ...
      <modal v-show="mdShow" @hidden="handleHidden">
        <div slot="md-title">Login in</div>
        <div class="error-wrap" slot="msg">
        ...
        <div class="login-wrap" slot="btnGroup">
